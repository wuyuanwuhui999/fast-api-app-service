...
class TencentDocsDownloader:
    def __init__(self, headless=False, render_delay=5, output_format="png"):
...
def main():
    urls = [
        "https://docs.qq.com/aio/DTmVib1dSdGdXZGp4?from_wiki_space=1&nlc=1&p=aVE5heAUWJlPGbcqIpicvR"
    ]
