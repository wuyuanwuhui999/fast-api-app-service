...
if __name__ == "__main__":
    try:
        result1 = convert_to_png("C:/Users/27501/Desktop/选择文档.png","F:/flutter/flutter-chat-app-ui/选择文档.png",360)
        print(f"图片已保存到: {result1}")

        result2 = convert_to_png("C:/Users/27501/Desktop/选择文档.png","F:/uniapp/uniapp-chat-app-ui/选择文档.png",360)
        print(f"图片已保存到: {result2}")

        # 示例2: 转换格式并调整宽度为800px
        result2 = convert_to_png("C:/Users/27501/Desktop/选择文档.png", "F:/Harmony/harmony-arkTs-chat-ui/选择文档.png",360)
        print(f"图片已保存到: {result2}")

        result2 = convert_to_png("C:/Users/27501/Desktop/选择文档.png","F:/uniapp/新建文件夹/选择文档.png", 360)
        print(f"图片已保存到: {result2}")
    except Exception as e:
        print(f"错误: {e}")